      ...
      >
        ...
        <div className="min-h-0 flex-1 overflow-y-auto px-1 py-5">
          {conflictPending && (
            ...
            >
              تنظیمات ارائه جای دیگری تغییر کرده است. تغییرات صدای محلی شما حفظ شده است و برای جلوگیری از بازنویسی ناخواسته، ذخیره دوباره تا تعیین تکلیف تعارض غیرفعال می‌ماند.
            </Notice>
          )}
